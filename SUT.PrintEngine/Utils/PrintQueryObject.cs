...
namespace SUT.PrintEngine.Utils
{
    public class PrintQueryObject : INotifyPropertyChanged
    {
        ...
        protected void SetPrinterSettings()
        {
            ...
            if (!CacheHelper.Contains(key))
            {
                var printerSettings = new System.Drawing.Printing.PrinterSettings { PrinterName = CurrentPrinterName };
                _printerSettings = printerSettings;
                return;
                CacheHelper.Add(key, printerSettings);
            }
        ...
        private PaperSize GetDefaultPaperSize()
        {
            ...
            return _printerSettings.DefaultPageSettings.PaperSize;
