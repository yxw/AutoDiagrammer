...
namespace AutoDiagrammer.WPF_Specific_Service_Implementations
{
    /// <summary>
    ...
    public class WPFUIVisualizerService : Cinch.IUIVisualizerService
    {
        ...
        public WPFUIVisualizerService()
        {
            ...
            Register("AboutWindowPopup", typeof(AboutWindowPopup));
            Register("HelpPopup", typeof(HelpPopup));
            Register("MethodBodyILPopup", typeof(MethodBodyILPopup));
            Register("NonAssociatedVertexPopup", typeof(NonAssociatedVertexPopup));
            Register("SettingsWindowPopup", typeof(SettingsWindowPopup));
        }
        #endregion
